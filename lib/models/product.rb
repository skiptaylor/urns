class Product < Sequel::Model
  ...
  dataset_module do
    ...
    def fineart
      where(productstyle_id: Productstyle.where(product_style: 'Fine Art').select(:id)) && where(productstyle_id: Productstyle.where(product_style: 'Fine Art Keepsake').select(:id))
    end

...
(function ($) {
    ...
    ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                ...
                '.dd-selected{ overflow:hidden; display:block; padding:3px; font-weight:normal;}' +
                ...
                '.dd-option-image, .dd-selected-image { vertical-align:middle; float:left; margin-right:1px; max-width:32px;}' +
                '.dd-image-right { float:right; margin-right:15px; margin-left:5px;}' +
                '.dd-container{ position:relative;} .dd-selected-text { font-weight:400}</style>';
